...
public class ModifierArgument implements ArgumentType<Modifier> {
  ...
  private static final DynamicCommandExceptionType MODIFIER_NOT_FOUND = new DynamicCommandExceptionType(name -> TConstruct.makeTranslation("command", "modifier.not_found", name.toString()));
