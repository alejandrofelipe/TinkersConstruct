...
public class ThrownShuriken extends Projectile implements ToolProjectile, ProjectileWithPower, ProjectileWithKnockback, ReusableProjectile {
  ...
  public void tick() {
    ...
    if (hit.getType() == HitResult.Type.BLOCK) {
      ...
      // 1.21: portal handling is unified through the Portal interface; both nether portals and end
      // gateways register the entity for teleport during handlePortal() on the next entity tick
