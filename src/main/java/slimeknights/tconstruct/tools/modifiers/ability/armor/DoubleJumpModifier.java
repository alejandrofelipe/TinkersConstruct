...
public class DoubleJumpModifier extends Modifier {
  ...
  protected void registerHooks(Builder hookBuilder) {
    ...
    hookBuilder.addModule(AttributeModule.builder(TinkerAttributes.JUMP_COUNT.get(), Operation.ADD_VALUE).slots(EQUIPMENT_SLOTS).tooltipStyle(TooltipStyle.NONE).flat(1));
  }
