...
public class FluidEffectProvider extends AbstractFluidEffectProvider {
  ...
  protected void addFluids() {
    ...
    addFluid(TinkerFluids.blazingBlood.getTag(), FluidType.BUCKET_VOLUME / 20)
      ...
      .addEntityEffects(FluidMobEffect.builder().effect(MobEffects.GLOWING.value(), 20*5).buildEntity(TimeAction.ADD))
    ...
    addSlime(TinkerFluids.earthSlime)
      .addEntityEffects(FluidMobEffect.builder().effect(MobEffects.MOVEMENT_SLOWDOWN.value(), 20*5).buildEntity(TimeAction.ADD))
    ...
    addSlime(TinkerFluids.ichor)
      .addEntityEffects(FluidMobEffect.builder().effect(MobEffects.SLOW_FALLING.value(), 7*20).effect(MobEffects.MOVEMENT_SLOWDOWN.value(), 20*5).buildEntity(TimeAction.ADD))
    ...
    addFluid(TinkerFluids.venom, FluidValues.SIP).addEffect(FluidMobEffect.builder().effect(MobEffects.POISON.value(), 20 * 5).effect(MobEffects.DAMAGE_BOOST.value(), 20 * 10), TimeAction.ADD);
    ...
    compatMetal(TinkerFluids.moltenZinc).fireDamage(2).addEffect(FluidMobEffect.builder().effect(MobEffects.MOVEMENT_SPEED.value(), 20 * 10), TimeAction.SET);
    compatMetal(TinkerFluids.moltenBrass, "zinc").fireDamage(3).addEffect(FluidMobEffect.builder().effect(MobEffects.FIRE_RESISTANCE.value(), 20 * 8), TimeAction.SET);
    // tin/pewter - sight/strength
    compatMetal(TinkerFluids.moltenTin).fireDamage(2).addEffect(FluidMobEffect.builder().effect(MobEffects.NIGHT_VISION.value(), 20 * 8), TimeAction.SET);
    compatMetal(TinkerFluids.moltenPewter, "tin", "lead").fireDamage(3).addEffect(FluidMobEffect.builder().effect(MobEffects.DAMAGE_BOOST.value(), 20 * 7), TimeAction.SET);
    // gold/electrum/rose gold - health/haste/absorption
    addMetal(TinkerFluids.moltenGold).magicDamage(2).addEffect(FluidMobEffect.builder().effect(MobEffects.REGENERATION.value(), 20 * 6, 2), TimeAction.SET);
    compatMetal(TinkerFluids.moltenElectrum, "silver").magicDamage(3).addEffect(FluidMobEffect.builder().effect(MobEffects.DIG_SPEED.value(), 20 * 8, 1), TimeAction.SET);
    addMetal(TinkerFluids.moltenRoseGold).magicDamage(3).addEffect(FluidMobEffect.builder().effect(MobEffects.ABSORPTION.value(), 20 * 15, 2), TimeAction.SET);
    // chromium/nicrosil - luck/xp
    compatMetal(TinkerFluids.moltenChromium).magicDamage(2).addEffect(FluidMobEffect.builder().effect(MobEffects.LUCK.value(), 20 * 5, 1), TimeAction.SET);
    ...
    compatMetal(TinkerFluids.moltenBendalloy).fireDamage(3).addEffect(FluidMobEffect.builder().effect(MobEffects.SATURATION.value(), 20 * 5, 1), TimeAction.SET);
    ...
    compatMetal(TinkerFluids.moltenDuralumin).magicDamage(3).addEffect(FluidMobEffect.builder().effect(MobEffects.INVISIBILITY.value(), 20 * 5, 1), TimeAction.SET);
    compatMetal(TinkerFluids.moltenSilver).magicDamage(2).addEntityEffect(new RemoveEffectFluidEffect(MobEffects.WITHER.value()));
    // non-cosmere ores
    compatMetal(TinkerFluids.moltenLead).fireDamage(2).addEffect(FluidMobEffect.builder().effect(MobEffects.POISON.value(), 20 * 5, 1), TimeAction.SET);
    compatMetal(TinkerFluids.moltenNickel).fireDamage(2).addEffect(FluidMobEffect.builder().effect(MobEffects.WEAKNESS.value(), 20 * 7, 1), TimeAction.SET);
    compatMetal(TinkerFluids.moltenPlatinum).fireDamage(2).addEffect(FluidMobEffect.builder().effect(MobEffects.DIG_SLOWDOWN.value(), 20 * 10, 1), TimeAction.SET);
    compatMetal(TinkerFluids.moltenTungsten).fireDamage(2).addEffect(FluidMobEffect.builder().effect(MobEffects.MOVEMENT_SLOWDOWN.value(), 20 * 10, 2), TimeAction.SET);
    compatMetal(TinkerFluids.moltenOsmium).fireDamage(2).addEffect(FluidMobEffect.builder().effect(MobEffects.MOVEMENT_SLOWDOWN.value(), 20 * 10, 2), TimeAction.SET);
    compatMetal(TinkerFluids.moltenUranium).fireDamage(2).addEffect(FluidMobEffect.builder().effect(MobEffects.POISON.value(), 20 * 10, 1), TimeAction.SET);
    // non-cosmere alloys
    compatMetal(TinkerFluids.moltenInvar, "nickel").fireDamage(3).addEffect(FluidMobEffect.builder().effect(MobEffects.HUNGER.value(), 20 * 10, 1), TimeAction.SET);
    compatMetal(TinkerFluids.moltenConstantan, "nickel").fireDamage(3).addEffect(FluidMobEffect.builder().effect(MobEffects.HUNGER.value(), 20 * 10, 1), TimeAction.SET);
    // slime metal
    ...
    // tinkers nether
    addMetal(TinkerFluids.moltenCobalt).fireDamage(3).addEffect(FluidMobEffect.builder().effect(MobEffects.DIG_SPEED.value(), 20 * 7, 1).effect(MobEffects.MOVEMENT_SPEED.value(), 20 * 7, 1), TimeAction.SET);
    ...
    addMetal(TinkerFluids.moltenHepatizon).coldDamage(4).addEffect(FluidMobEffect.builder().effect(MobEffects.WITHER.value(), 20 * 8, 1), TimeAction.SET);
    addMetal(TinkerFluids.moltenNetherite).impactDamage(5).addEffect(FluidMobEffect.builder().effect(MobEffects.BLINDNESS.value(), 20 * 5, 1), TimeAction.SET);
    // tinkers end
    ...
    // thermal compat
    compatFluid("glowstone", FluidValues.GEM).addEffect(FluidMobEffect.builder().effect(MobEffects.GLOWING.value(), 20 * 10), TimeAction.ADD).addBlockEffect(new PlaceBlockFluidEffect(TinkerCommons.glowBlock.get()));
    ...
    compatMetal(TinkerFluids.moltenLumium).magicDamage(4).addEffect(FluidMobEffect.builder().effect(MobEffects.GLOWING.value(), 20 * 5, 1).effect(MobEffects.MOVEMENT_SPEED.value(), 20 * 5, 1).effect(MobEffects.JUMP.value(), 20 * 5, 1), TimeAction.SET);
    ...
    // mekanism compat
    compatMetal(TinkerFluids.moltenRefinedGlowstone).magicDamage(3).addEffect(FluidMobEffect.builder().effect(MobEffects.GLOWING.value(), 20 * 10, 1), TimeAction.SET);
    ...
    compatFluid("plantoil", 50)
      ...
      .addEntityEffects(FluidMobEffect.builder().effect(MobEffects.CONFUSION.value(), 5 * 20, 1).buildEntity(TimeAction.ADD));
    {
