 ...
 *
 * <p>In 1.20/Forge this temporarily unfroze the registry via {@code ForgeRegistry#unfreeze()}. NeoForge does not expose
 * a public unfreeze hook, so we register the dummy value into the vanilla {@link Registry} via {@link Registry#register}.
 * Datagen runs before the registries are frozen, so this works for the datagen-only callers of this class.
 */
