...
public sealed interface MaterialVariantId permits MaterialId, MaterialVariantIdImpl {
  ...
  EntityDataSerializer<MaterialVariantId> DATA_ACCESSOR = EntityDataSerializer.simple(StreamCodec.of((buffer, material) -> material.toNetwork(buffer), MaterialVariantId::fromNetwork));
